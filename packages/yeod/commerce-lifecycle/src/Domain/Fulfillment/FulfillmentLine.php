...
final class FulfillmentLine
{
    ...
    {
        return $this->fulfilledQuantity === $this->orderedQuantity;
    }

    /**
     * Return a new line with the fulfilled quantity increased, preserving
     * aggregate invariants and leaving this instance unchanged (immutable).
     *
     * @throws InvalidArgumentException When the quantity would exceed the ordered quantity.
     */
